...
def nomralize_value (val, min_val, max_val):
    return (val - mean)/sd
...
def batch_grad_descent(X, y, alpha=0.1, num_iter=1000, check_gradient=False):
    ...
    for i in range (num_iter):
        ...
        loss_hist [i] = compute_square_loss (X_batch, y_batch, theta_hist [i])
        theta_hist [i+1] = theta_hist [i] - alpha * compute_square_loss_gradient (X_batch, y_batch, theta_hist [i])
